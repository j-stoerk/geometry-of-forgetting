...
results are quoted in this manuscript), and \texttt{evaluate\_oq\_hardened.py} an
...
impossibility boundary for machine unlearning under shared representations.
...
sizing rule as Sec.~\ref{si:cheapgn}.
...
inherits replay's floor reduction without its storage or privacy cost.
