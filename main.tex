...
damping upgrades, and \texttt{fig\_stream\_density.py} the share-density figure;
...
multimodal settings (Sec.~\ref{si:extensions}), and memory-systems and control extensions
(Sec.~\ref{si:memory}). All results are exact-regime simulations or
