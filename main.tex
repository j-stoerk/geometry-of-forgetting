...
probe-similarity, consolidation, floor-scheduled-memory, and dream-replay studies of
Secs.~\ref{si:cheapgn}, \ref{si:llm}, and~\ref{si:memory};
...
examples. Replay and structural allocation are therefore not opposing families: the same
low-rank state implements both, and buffer-free generative rehearsal inherits replay's floor
reduction without its storage or privacy cost.
