...
subspace $\mathbb{E}[J_w J_w^\top]$ rather than a stale $\Sig_A$. The generalization in
fact goes further: recast in function space, the identity, the removability dichotomy, the
floor, and a continuous-time exact-retention guarantee all hold with A1 removed entirely,
for arbitrary architectures (Sec.~\ref{si:beyond})---A1 buys finite-step exactness, not
the geometry itself.
