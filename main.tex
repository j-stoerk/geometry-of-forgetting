...
\texttt{kaggle\_probe\_gate\_llm.py} the probe-gate protocol on similar text domains;
...
functional instead of the input geometry. A runnable protocol for the real-text test---the
probe gate against naive, protect-all, and the input gate on four similar news domains with
sequential LoRA---is released as \texttt{kaggle\_probe\_gate\_llm.py}.
